...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    description:
      "Co-founded JumpingMinds AI from zero. Grew from 2 founders to 15-engineer team (6 backend, 3 mobile, 3 web/infra, 3 product). Built 'Snuggles' — 24×7 AI companion chatbot in early 2022, months before ChatGPT's public launch (Nov 2022). LLM-integrated agentic NLP matching engine (v1 rule-based → v4 real-time sentiment + agentic feedback loops); Chat API p99 3s → 250ms (12×) under live traffic with zero downtime. 35 min daily engagement vs. 10–15 min industry avg (2.3×); 40M+ AI training data points; 30% positive mood shift for 3-month+ users. Grew to 1M+ users across India, US, UK, and Scandinavia. Content-first GTM: built 118K Instagram followers before app launch; 7M+ Reels impressions; 30% follower growth in 6 months. 10+ enterprise B2B clients including Medibuddy, BluSmart, Marsh India. Backed by ex-Disney India CEO, ex-Disney CTO, and ex-Disney SVP Product. $1.3M funded. Google for Startups Accelerator 2022. Google Play Best Hidden Gem 2021. Wound down cleanly Aug 2024.",
    tech: [
      "Co-Founder",
      "LLM / NLP Systems",
